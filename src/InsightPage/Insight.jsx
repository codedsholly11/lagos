  ...
  return (
    <div className='flex flex-col gap-[40px]'>
        <div className='flex flex-col gap-[50px] py-[30px] '>
            ...
            <div className='flex gap-[20px]  px-[70px] '>
                <div className='flex gap-[30px] rounded-xl items-center justify-center p-[20px] w-[40vw] h-[30vh] bg-blue-400'>
                ...
                <div className='flex gap-[30px] rounded-xl items-center justify-center p-[20px] shadow-xl w-[40vw] h-[30vh] bg-blue-400'>
